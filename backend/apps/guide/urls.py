...
urlpatterns = [
    ...
    path("regenerate/", RegenerateTodayView.as_view(), name="guide-regenerate-today"),
    ...
    path("audio/dbr-intro/<int:reading_id>/", DbrIntroAudioView.as_view(), name="guide-dbr-intro-audio"),
